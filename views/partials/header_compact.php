<?php
/**
 * Header layout preset: Compact.
 * Thin top bar + tight header (logo left, actions right) + compact navbar with inline search.
...
<header class="site-header compact-header">
  <div class="container">
    <a href="/" class="logo" aria-label="<?php echo e($siteName); ?> home">
      <?php if ($logo): ?>
        <img src="<?php echo e('/' . ltrim($logo, '/')); ?>" alt="<?php echo e($siteName); ?>" width="160" height="40">
      <?php else: ?>
...
<nav class="navbar compact-navbar" id="navbar">
  <div class="container">
    ...
    <div class="nav-search">
      <form action="/search" method="get" role="search">
        <input type="text" name="q" placeholder="Search..." aria-label="Search" value="<?php echo e($_GET['q'] ?? ''); ?>">
